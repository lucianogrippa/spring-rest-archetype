...
public class LogHelper {
	...
	public void logError(String message) {
		message = message.replaceAll("[^${symbol_escape}${symbol_escape}x20-${symbol_escape}${symbol_escape}x7e]", "");
	...
	public void logMethod(String methodName, Object[] params) {
		methodName = methodName.replaceAll("[^${symbol_escape}${symbol_escape}x20-${symbol_escape}${symbol_escape}x7e]", "");
